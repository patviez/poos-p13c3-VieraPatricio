...
- **Nombre:** Entrenador
- **Responsabilidad principal:** Capturar criaturas, buscar criaturas, 
- **Atributos necesarios:** Nombre, edad, genero, 
- **Métodos posibles:** iniciar interaccion con criatura, abrir inventario, lanzar capturador
- **Clase con la que necesita colaborar:** Criatura, inventario
- **Regla o criterio de aceptación que la justifica:** Captura exitosa
- **Responsabilidad que no debería asumir:** Tener mas de seis criaturas, quedar sin criaturas
...
1. ¿Existe una clase que concentre casi todas las acciones? ¿Cuál y qué responsabilidad debería trasladarse?
   ...
   **Respuesta:** El inventario, deberia 
